...
public class SurveyService {
	...
	public Question retrieveAllSurveyByQuestionId(String surveyId, String questionId) {
		// TODO Auto-generated method stub

		List<Question> questions=retrieveAllSurveyQuestions(surveyId);
		if (questions==null) return null;
		Optional<Question> question=questions.stream().filter(q -> q.getId().equalsIgnoreCase(questionId)).findFirst();
	...
	public Question updateSurveyQuestions(String surveyId, String questionId, Question question) {
		List<Question> questions=retrieveAllSurveyQuestions(surveyId);
		if(questions==null) return null;
		deleteSurveyQuestions(surveyId,questionId);
		addNewSurveyQuestions(surveyId,question);
		return question;
	}
}
